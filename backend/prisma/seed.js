    ...
    if (!floorMap) {
        floorMap = await prisma.floorMap.create({
            data: {
                ...
                desks: {
                    create: [
                        { deskNumber: 'A-101', deskType: client_1.DeskType.hot_desk, xCoordinate: 150, yCoordinate: 200, status: client_1.DeskStatus.available, monthlyPrice: 250, dailyPrice: 25 },
                        { deskNumber: 'A-102', deskType: client_1.DeskType.hot_desk, xCoordinate: 250, yCoordinate: 200, status: client_1.DeskStatus.available, monthlyPrice: 250, dailyPrice: 25 },
                        { deskNumber: 'B-201', deskType: client_1.DeskType.dedicated_desk, xCoordinate: 400, yCoordinate: 350, status: client_1.DeskStatus.occupied, monthlyPrice: 450, dailyPrice: 45 },
                        { deskNumber: 'B-202', deskType: client_1.DeskType.dedicated_desk, xCoordinate: 500, yCoordinate: 350, status: client_1.DeskStatus.available, monthlyPrice: 450, dailyPrice: 45 },
                        { deskNumber: 'C-301', deskType: client_1.DeskType.private_cabin, xCoordinate: 750, yCoordinate: 150, width: 120, height: 120, status: client_1.DeskStatus.reserved, monthlyPrice: 1200, dailyPrice: 120 },
                    ],
                },
            },
        });
    ...
    if (!floorMap2) {
        floorMap2 = await prisma.floorMap.create({
            data: {
                ...
                desks: {
                    create: [
                        { deskNumber: 'T-101', deskType: client_1.DeskType.hot_desk, xCoordinate: 180, yCoordinate: 220, status: client_1.DeskStatus.available, monthlyPrice: 280, dailyPrice: 28 },
                        { deskNumber: 'T-102', deskType: client_1.DeskType.dedicated_desk, xCoordinate: 380, yCoordinate: 320, status: client_1.DeskStatus.available, monthlyPrice: 480, dailyPrice: 48 },
                        { deskNumber: 'T-Cabin-1', deskType: client_1.DeskType.private_cabin, xCoordinate: 700, yCoordinate: 180, width: 140, height: 140, status: client_1.DeskStatus.available, monthlyPrice: 1350, dailyPrice: 135 },
                    ],
                },
            },
        });
    ...
    if (!floorMap3) {
        floorMap3 = await prisma.floorMap.create({
            data: {
                ...
                desks: {
                    create: [
                        { deskNumber: 'W-201', deskType: client_1.DeskType.hot_desk, xCoordinate: 200, yCoordinate: 250, status: client_1.DeskStatus.available, monthlyPrice: 300, dailyPrice: 30 },
                        { deskNumber: 'W-202', deskType: client_1.DeskType.dedicated_desk, xCoordinate: 450, yCoordinate: 300, status: client_1.DeskStatus.available, monthlyPrice: 500, dailyPrice: 50 },
                        { deskNumber: 'W-Suite-A', deskType: client_1.DeskType.private_cabin, xCoordinate: 800, yCoordinate: 200, width: 150, height: 150, status: client_1.DeskStatus.available, monthlyPrice: 1500, dailyPrice: 150 },
                    ],
                },
            },
        });
