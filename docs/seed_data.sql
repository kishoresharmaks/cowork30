...
(1, 'Ishwarji Cowork 30', 'downtown-main-hub', '201, 2nd Floor, ACME Plaza No 2, Opp. Sangam Cinema, Andheri Kurla Road, Chakala', 'Mumbai', 'MH', '400059', 19.1136, 72.8697, '7708888765 / 022-62396303 / 9820431183', 'cowork307@gmail.com', '08:00 AM', '08:00 PM', 1, NOW(3), NOW(3)),
...
(1, 1, 'System Admin', 'admin@cowork30.com', '$2b$10$w8T.N0V3F0p4WvQ9W8Wz4.69H0u5g9N7f0M0X0Z0Y0W0V0U0T0S0R', '+91 9820431183', 'Ishwarji Cowork 30', 'admin', 1000.00, 50.00, 20.00, NOW(3), NOW(3))
ON DUPLICATE KEY UPDATE `name` = VALUES(`name`);
