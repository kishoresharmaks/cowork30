    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex font-sans">
      ...
      <main className="flex-1 p-8 overflow-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-black text-white">Workspace Services Catalog Manager</h1>
            <p className="text-xs text-slate-400 mt-1">Manage corporate virtual addresses, day passes, and custom business services.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {services.map((s) => (
            <div key={s.id} className="bg-slate-900 border border-slate-800 rounded-3xl p-6 flex flex-col justify-between space-y-4">
              <div>
              ...
              <div className="pt-4 border-t border-slate-800 flex items-center justify-between text-xs">
                <span className="text-rose-400 font-bold">₹{s.startingPrice}/mo</span>
